    ...
    <div className="bg-secondary w-[100%] py-[10px]">
      <div className="container px-5">
        <div className="flex justify-between items-center text-white text-sm">
          ...
          <span className="bg-primary px-4 py-2 text-white rounded-full text-sm">New</span>
          </div>
          <div className="flex gap-4">
           ...
           <span className="font-semibold"> | </span>
           <span className="flex gap-2 items-center"><i class="fa-solid fa-dollar-sign text-primary"></i> Currency</span>
          </div>
        </div>
      </div>
    </div>
